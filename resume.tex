...
\personalinfo{%
  ...
  \github{\href{https://github.com/ag-ayush}{ag-ayush}}
...
\cvevent{Lane Follow Bot}{\href{https://www.github.com/ag-ayush/lane-follow-bot}{github.com/ag-ayush/lane-follow-bot}}{Fall 2018 Hackathon}{}
This was a small software program written using Python and OpenCV to detect white lines on green grass and then output which direction to move in order to stay between the two lines.
