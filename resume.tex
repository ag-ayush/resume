...
\cvsection{Projects}
  ...
  A web service, written using \textbf{Python flask}, \textbf{bootstrap}, \textbf{JavaScript} and \textbf{ajax}, that allows one to control their window shades.
  ...
  This was a small software program written using \textbf{Python} and \textbf{OpenCV} to detect white lines on green grass and then output which direction to move in order to stay between the two lines.
